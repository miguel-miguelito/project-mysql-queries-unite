...
Este projeto foi desenvolvido durante o curso da Trybe com o objetivo de trabalhar modelagem de banco de dados. Os requisitos do projeto estão detalhados a seguir.
